...
export const ru: TranslationDict = {
  ...
  pwaNotice: {
    ...
    title: 'Запись в фоне активна',
    desc: 'Боковая панель доступна только во вкладках браузера, но субтитры встречи автоматически записываются и сохраняются в фоне.',
    close: 'Понятно',
  },
};
